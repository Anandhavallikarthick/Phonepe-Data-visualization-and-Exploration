...
# Top Charts - TRANSACTIONS    
    if Type == "Transactions":
        ...
        with col1:
            ...
            mycursor.execute(f"select states, sum(Transaction_count) as Total_Transactions_Count, sum(Transaction_amount) as Total from aggregated_transaction where years = {Year} and quarter = {Quarter} group by states order by Total desc limit 10")
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/Anandhavallikarthick/Phonepe-Data-visualization-and-Exploration/blob/main/README.md")
